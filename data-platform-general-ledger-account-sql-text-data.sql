...
(
    ...
    CONSTRAINT `DataPlatformGeneralLedgerAccountTextData_fk` FOREIGN KEY (`ChartOfAccounts`, `GLAccount`) REFERENCES `data_platform_general_ledger_account_chart_of_accounts_data` (`ChartOfAccounts`, `GLAccount`)
) ENGINE = InnoDB
